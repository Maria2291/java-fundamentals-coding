 ...
 *         // 2. numele variabilei (rex, listaNumerePare, pret, isPresent, etc)
 *
 *         Integer number = 0;
 ...
 *
 *         //ATENTIE!!! La folosirea/apelul variabilei nu mai scriem tipul acesteia (folosim doar number, fara Integer)
 *         // Integer number = 100;
 *
 *         String text = " ";
...
public class Main {
    public static void main(String[] args) {
        ...
        Dog.bark(); // folodim clasa Dog si  nu obiectele de tipul clasei Dog
        rex.apport(); // folosim obiectul si nu clasa Dog
    ...
    public static Dog addDog () {
        ...
        // new Dog() - reprezinta apelul contstructorului din clasa Dog
